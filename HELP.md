...
* The original package name 'com.hankshop.shinobi-k' is invalid and this project uses 'com.hankshop.shinobik' instead.
...
* [Apache Freemarker](https://docs.spring.io/spring-boot/docs/2.7.7/reference/htmlsingle/#web.servlet.spring-mvc.template-engines)
