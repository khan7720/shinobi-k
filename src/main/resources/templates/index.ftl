              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="me-md-3 me-xl-5">
                    <h2>Welcome back,</h2>
                    <p class="mb-md-0">check your tasks here.</p>
                  </div>
                  <div class="d-flex">
          ...
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-description">当前状态表</p>
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>压力</td>
                        <td>${stats.pressure}</td>
                      </tr>
                      <tr>
                        <td>体格</td>
                        <td>${stats.physique}</td>
                      </tr>
                      <tr>
                        <td>心态</td>
                        <td>${stats.mentality}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
